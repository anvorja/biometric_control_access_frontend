...
export const UserEdit = () => {
    ...
    const validateForm = () => {
        ...
        // Validar nombre
        const nameValidation = validateAndFormatInput.validateName(user.full_name);
        ...
        } else if (!validateAndFormatInput.validateEmail(user.email)) {
    ...
    const handleFieldChange = (field) => (event) => {
        ...
        } else if (field === 'email' && sanitizedValue.trim()) {
            const isValid = validateAndFormatInput.validateEmail(sanitizedValue);
            setErrors(prev => ({
                ...prev,
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const formattedData = {
                ...user,
                email: validateAndFormatInput.formatEmail(user.email),
                full_name: validateAndFormatInput.formatName(user.full_name),
                employee_id: validateAndFormatInput.sanitizeInput(user.employee_id)
            };
